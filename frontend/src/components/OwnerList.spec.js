...
describe('components', () => {
  describe('OwnerList', () => {
    ...
    it('initial render with owners without pets and verify owner-1 details', () => {
      ...
      const owner1NameTd = ownerItems[0].children[1].children[0];
      expect(owner1NameTd).toBe("Jowena Chua");
    ...
    it('initial render with owners without pets and verify owner-2 details', () => {
      ...
      const owner1NameTd = ownerItems[1].children[1].children[0];
      expect(owner1NameTd).toBe("Wally Crocker");
      const owner1Details = ownerItems[1].findByProps({ className: "mt-4" });
      expect(owner1Details.type).toBe(Table);      
      const petsElementForOwner1 = owner1Details.findByType(PetList);
      expect(petsElementForOwner1.children.length).toBe(1);
      const addPetButton = petsElementForOwner1.findByType(Button);
    ...
    it('initial render with owners without pets and verify owner-3 details', () => {
      ...
      const owner1NameTd = ownerItems[2].children[1].children[0];
      expect(owner1NameTd).toBe("Monisha Suresh");
      const owner1Details = ownerItems[2].findByProps({ className: "mt-4" });
      expect(owner1Details.type).toBe(Table);      
      const petsElementForOwner1 = owner1Details.findByType(PetList);
      expect(petsElementForOwner1.children.length).toBe(1);
      const addPetButton = petsElementForOwner1.findByType(Button);
